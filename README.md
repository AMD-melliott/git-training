...
**Skills:** Fork, clone, branch, commit, push, pull requests<br>
...
**Skills:** VS Code diff view, staging, visual Git workflow<br>
...
**Skills:** Conflict resolution, branching, merging<br>
...
**Skills:** Multi-window editing, Markdown preview, documentation formatting<br>
...
**Skills:** Project-wide search and replace, batch commits, refactoring<br>
